...
import org.pdes.simulator.ExistingModel_Simulator;
import org.pdes.simulator.model.ProjectInfo;

public class MultiRun_ExistingModel extends AbstractSimulationAction{
	private final String text = "Existing model for data generation";
	
	public MultiRun_ExistingModel(){
